...
var Driver = module.exports = function Driver(opts) {
  ...
  extraParams = Object.keys(extraParams).length > 0 ? extraParams : opts;

  var driver = Basestar();
  driver.name = extraParams.name;
  driver.pin = extraParams.pin;
  driver.connection = opts.connection || opts;
  //driver.adaptor = this.connection.adaptor;
  driver.interval = extraParams.interval || 10;
